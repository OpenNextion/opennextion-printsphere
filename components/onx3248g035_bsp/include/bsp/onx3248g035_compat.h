...
/*
 * Compatibility header for the PrintSphere application BSP surface.
 *
 * The public build exposes only the ONX3248G035 profile. These declarations keep
 * the app-side bsp_* calls stable without depending on the original display BSP.
 */
